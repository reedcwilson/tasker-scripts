...
var getMessage = function(type) {
  var messages = {
    ...
    "game_night": "Does family game night work for everyone on Monday at 7:00? Do we have volunteers for a thought and a treat?",
    ...
    "lunch_bros": "What day this week is best for lunch?",
  };
  switch(type) {
    case "lost_boy":
    case "visit":
...
tk.setGlobal("%ScheduledDiffMonth", Math.max(-1, diffMonth-1));
